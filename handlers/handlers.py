...
async def show_stock(message: Message):
    ...
    await message.answer(stock.__str__(include_eggs=True, include_easter=True,
                                       include_honey=True, include_night=True, include_cosmetics=True), reply_markup=main_kb)
